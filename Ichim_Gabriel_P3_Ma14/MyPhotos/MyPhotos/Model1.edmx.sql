...
-- --------------------------------------------------
-- Date Created: 05/26/2020 22:58:00
-- Generated from EDMX file: C:\Users\ichim\Desktop\TSP.NET\TSP.NET\MyPhotos\MyPhotos\Model1.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_MediasPhotos]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Photos] DROP CONSTRAINT [FK_MediasPhotos];
GO
IF OBJECT_ID(N'[dbo].[FK_MediasVideos]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Videos] DROP CONSTRAINT [FK_MediasVideos];
GO
IF OBJECT_ID(N'[dbo].[FK_PhotosTags_photo]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tags_photo] DROP CONSTRAINT [FK_PhotosTags_photo];
GO
IF OBJECT_ID(N'[dbo].[FK_VideosTags_video]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tags_video] DROP CONSTRAINT [FK_VideosTags_video];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Tags_video]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Tags_video];
GO
IF OBJECT_ID(N'[dbo].[Tags_photo]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Tags_photo];
GO
